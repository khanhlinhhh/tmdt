	...
	class slider extends controller{
		...
		public function insert(){
			...
			if (isset($_POST["submit"])) {
				...
				// if (empty($_POST["ten_san_pham"])||empty($_POST["gia"])||empty($_POST["so_luong_hang"])|| empty($_POST["hinh"])) {
				// 	$this->viewadmin("masterlayout",[
				// 	"page"=>"sanpham/insert",
				// 	"loai_hang"=>$this->loai_hang_hoamodel->get(),
				// 	"result"=>$result_mess,
				...
				// else{
					...
					// $kq = $this->hang_hoamodel->insert($ten_san_pham,$gia,$so_luong_hang,$hinh,$mo_ta,$loai_san_pham);
					// $this->viewadmin("masterlayout",[
					// "page"=>"sanpham/insert",
					// "loai_hang"=>$this->loai_hang_hoamodel->get(),
					// "id_don"=>$this->don_hangmodel->get_all_id(),
