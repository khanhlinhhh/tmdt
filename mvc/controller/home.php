<?php 
	...
	class home extends controller{
		...
		// 	$this->view("masterlayout",[
		// 		"page"=>"page/trangchu",
		// 		"slider"=>$this->slidermodel->typeslider($id),
		// 		"loai_hang"=>$this->loai_hang_hoamodel->get(),
		// 		"detail"=>$this->hang_hoamodel->detail($id),
		// 	]);
		// }
		...
		// 		if (empty($_POST["ho_ten"])|| empty($_POST["sdt"])||empty($_POST["dia_chi"])||empty($_POST["ten_hang"])||
		// 				empty($_POST["sl"])||empty($_POST["price"])) {
		// 		$this->view("masterlayout",[
		// 		"loai_hang"=>$this->loai_hang_hoamodel->get(),
		// 		"detail"=>$this->hang_hoamodel->detail($id),
		// 		"page"=>"page/cart",
		...
		// 		$so_luong_hang= $_POST["sl"];
		// 		$gia_don_hang= $_POST["price"];
		// 		$ngay_dat_hang = $_POST["ngay_dat_hang"];
		// 		$don_hang = $this->don_hangmodel->insert($ten_khach_hang,$so_dien_thoai,$dia_chi,$ngay_dat_hang);
		// 		$id_don_hang = $this->don_hangmodel->max();
		// 		while ($id_max =mysqli_fetch_array($id_don_hang)) {
		// 			$id_hang = $id_max["id"];
		// 		}
		// 		$chi_tiet_don_hang = $this->chi_tiet_don_hangmodel->insert($id,$so_luong_hang,$gia_don_hang,$id_hang);
		// 		$detail = $this->hang_hoamodel->detail($id);
		// 		while ($sl = mysqli_fetch_array($detail)) {
		// 			$tong = $sl["so_luong_hang"];
		// 		}
			
		// 		$final_total = $tong - $so_luong_hang;
		// 		$hang_hoa = $this->hang_hoamodel->update_hang($id,$final_total);
		// 		$this->view("masterlayout",[
		// 		"loai_hang"=>$this->loai_hang_hoamodel->get(),
		// 		"detail"=>$this->hang_hoamodel->detail($id),
		// 		"page"=>"page/cart",
		...
		public function action(){
			if (isset($_POST["action"])) {
				...
				// "page"=>"page/trangchu",
				// "loai_hang"=>$this->loai_hang_hoamodel->get(),
				// "all_product"=>$this->hang_hoamodel->search_product($minimum_price,$maximum_price),
			// ]);
				// echo "<pre>";
				// print_r($kq);
				// print_r($_POST);
